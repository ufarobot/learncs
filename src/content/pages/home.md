...
blocks:
  ...
  - template: "curriculum-accordion"
    ...
    modules:
      - title: "Модуль 1: Робот исполнитель"
        media:
      ...
      - title: "Модуль 2: Графика и анимация"
        media:
      ...
      - title: "Модуль 3: Основы программирования"
        media:
      ...
      - title: "Модуль 4: Массивы и строки"
        intro:
          - "По окончанию модуля вы сможете:"
        sections:
      ...
      - title: "Модуль 6: Клеточные автоматы, змейка и моделирование"
        media:
      ...
      - title: "Модуль 7: Объектно-ориентированное программирование"
        media:
      ...
      - title: "Модуль 9: Введение в алгоритмы и структуры данных"
        media:
