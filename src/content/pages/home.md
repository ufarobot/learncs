    ...
    items:
      ...
      - - "Какой ноутбук нужен для занятий?"
        - |-
          ...
          Важны нормальные клавиатура, тачпад, зарядка и экран. Минимум по экрану — Full HD 1920x1080, комфортнее 2K, Retina или выше: на занятии почти всегда открыты два окна одновременно, например теория или задачи в одном и редактор кода в другом. На низком разрешении приходится постоянно переключаться между окнами, это сбивает темп. 14-16 дюймов обычно удобны по балансу размера и веса; для работы в два окна лучше 15-16 дюймов или 14 дюймов с высоким разрешением. Если тачпад неудобный, лучше взять обычную мышку.
