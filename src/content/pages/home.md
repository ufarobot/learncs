---
title: "Олимпиадная информатика для школьников — learncs.ru"
description: "Онлайн-занятия для школьников 5–11 классов: индивидуальная траектория, программирование и задачи с автопроверкой."
blocks:
  - template: "hero-split"
    id: "top"
